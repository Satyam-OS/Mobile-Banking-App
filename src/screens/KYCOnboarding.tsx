          ...
          <View style={styles.formContent}>
            ...
            <View style={styles.inputWrapper}>
              <TextInput
                ...
                onChangeText={(val) => setFormData({ ...formData, pincode: val.replace(/[^0-9]/g, '') })}
              />
            </View>
          </View>
        );
        ...
        return (
          <View style={styles.formContent}>
            <TouchableOpacity style={styles.uploadCard}>
              <View style={[styles.uploadIconBox, { backgroundColor: '#DBEAFE' }]}>
            ...
            <TouchableOpacity style={[styles.uploadCard, { marginTop: 12 }]}>
              <View style={[styles.uploadIconBox, { backgroundColor: '#DBEAFE' }]}>
            ...
            <View style={styles.typeSelector}>
              ...
              <View style={styles.row}>
                {['Savings', 'Current'].map((type) => (
                  <TouchableOpacity
                    key={type}
                    onPress={() => setFormData({ ...formData, accountType: type.toLowerCase() })}
                    style={[styles.typeBtn, formData.accountType === type.toLowerCase() && styles.typeBtnActive]}
                  >
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.primaryBtn} onPress={handleNext} activeOpacity={0.8}>
          <Text style={styles.primaryBtnText}>
            {currentStep === 4 ? 'Start Video KYC' : 'Continue'}
          </Text>
        ...
        <View style={styles.secureTag}>
          ...
          <Text style={styles.secureText}>YOUR DATA IS SECURE & ENCRYPTED</Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  uploadCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFF', borderWidth: 1, borderStyle: 'dashed', borderColor: '#3B82F6', borderRadius: 16, padding: 16, marginTop: 10 },
